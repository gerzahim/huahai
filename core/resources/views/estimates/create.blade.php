            ...
            <div class="invoice">
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-5" style="padding: 0px">
                  <div class="form-group">
                    {!! Form::label('estimate_no', trans('application.estimate_number')) !!} {!! Form::text('estimate_no',$estimate_num, ['class' => 'form-control input-sm', 'id' => 'estimate_no', 'required']) !!}
                  </div>
                  <div class="form-group">
                    {!! Form::label('estimate_date', trans('application.estimate_date')) !!} {!! Form::text('estimate_date',date('Y-m-d'), ['class' => 'form-control datepicker input-sm' , 'id' => 'estimate_date', 'required','readonly']) !!}
                  </div>
                </div>
              </div>
              <div class="col-md-12">
                <table class="table table-striped" id="item_table">
                  ...
                  <tbody>
                    <tr class="item">
                      <td></td>
                      <td>
                        <div class="form-group">{!! Form::text('item_name',null, ['class' => 'form-control input-sm item_name', 'id'=>"item_name" , 'required']) !!}</div>
                      </td>
                      <td>
                        <div class="form-group">{!! Form::textarea('item_description',null, ['class' => 'form-control item_description input-sm', 'id'=>"item_description", 'rows'=>'1' ]) !!}</div>
                      </td>
                      <td>
                        <div class="form-group">{!! Form::input('number','quantity',null, ['class' => 'form-control calcEvent quantity input-sm', 'id'=>"quantity" , 'required', 'step' => 'any', 'min' => '0']) !!}</div>
                      </td>
                      <td>
                        <div class="form-group">{!! Form::input('number','price',null, ['class' => 'form-control calcEvent price input-sm', 'id'=>"price", 'required','step' => 'any', 'min' => '0']) !!}</div>
                      </td>
                      <td>
                        <div class="form-group">{!! Form::customSelect('tax',$taxes['options'],$taxes['default'], ['class' => 'form-control calcEvent tax input-sm', 'id'=>"tax"]) !!}</div>
                      </td>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  {!! Form::label('notes', trans('application.notes')) !!} {!! Form::textarea('notes',null, ['class' => 'form-control input-sm text_editor','rows' => '2']) !!}
                </div>
                <div class="form-group">
                  {!! Form::label('terms', trans('application.terms')) !!} {!! Form::textarea('terms',$settings ? $settings->terms : '', ['class' => 'form-control input-sm text_editor', 'rows' => '2']) !!}
                </div>
              </div>
              <div class="col-md-12">
