              ...
              {!! Form::model($transaction, ['route' => ['inventory.update', $transaction->uuid], 'method' => 'PATCH']) !!}
                ...
                <div class="form-group">
                  <div class="col-sm-12">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="transaction_types_in1">Reason - Type Out</label>
                            <select id="transaction_types_in" name="transaction_types_in" class="form-control input-sm ">
                                <option @if ($transaction->transaction_types_in == '0') selected="selected" @endif value="0">Sales</option>
                                <option @if ($transaction->transaction_types_in == '1') selected="selected" @endif value="1">Loan</option>
                                <option @if ($transaction->transaction_types_in == '2') selected="selected" @endif value="2">RMA OUT</option>
                            </select>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      {!! Form::label('number_types_in1', 'RMA / INVOICE / REF #') !!} {!! Form::text('number_types_in', $transaction->number_types_in, ['class' => 'form-control input-sm']) !!}
