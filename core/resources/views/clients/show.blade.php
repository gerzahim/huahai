      ...
      <div class="box box-solid">
        <div class="box-body">
          <table class="table table-striped">
            ...
            <tr>
              <td><dt>{{ trans('application.ein_number') }}</dt></td>
              <td>{{ $client->ein_number }}</td>
            </tr>
            <tr>
              <td><dt>{{ trans('application.resale_tax') }}</dt></td>
              <td>{{ $client->resale_tax }}</td>
            </tr>
            <tr>
              <td><dt>{{ trans('application.totalize_clients') }}</dt></td>
              <td>{{ $client->totalize_clients }}</td>
            </tr>
            <tr>
